...
class NjuCpolBaseDataset(Dataset):
    ...
    @staticmethod
    def dataloader(data_dir, dim_list=None, sub_dir="1.0km", batch_size=16, window_size=-1, window_step=1, shuffle=True, device='cpu', loader_args=None, **kwargs) -> DataLoader:
